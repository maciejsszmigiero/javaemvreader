...
public class EMVTags {
    ...
    public static final Tag APP_SELECT_REGISTERED_PROPRIETARY_DATA  = new TagImpl("9f0a", TagValueType.BINARY, "Application Selection Registered Proprietary Data", "Card data for market proprietary terminal functionality, contains an array of: sub-ID (2 bytes), sub-data-length (1 byte, L), sub-data (L bytes); sub-ID = 0001 is EEA Product Identification");
